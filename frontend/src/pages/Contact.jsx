    ...
    <main className="max-w-[1000px] mx-auto py-16 px-6 animate-fade-in">
      ...
      <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] border-[1.5px] border-slate-200/60 overflow-hidden flex flex-col md:flex-row min-h-[500px] animate-slide-up delay-100">
        <div className="md:w-5/12 bg-gradient-to-br from-primary to-primary-dark p-10 flex flex-col items-center justify-center text-white text-center relative overflow-hidden">
          ...
          <div className="absolute bottom-0 right-0 w-80 h-80 bg-white opacity-5 rounded-full translate-x-1/3 translate-y-1/3 pointer-events-none" />
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href={`tel:${PHONE}`} className="text-slate-600 text-sm mb-1 block hover:text-primary">
                  +251 980 164 320
                </a>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:Foyorikasa@gmail.com" className="text-slate-600 text-sm mb-1 block hover:text-primary">
                  Foyorikasa@gmail.com
                </a>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm mb-1 leading-relaxed">{STORE_LOCATION_TITLE}</p>
                <p className="text-slate-500 text-sm mb-2 leading-relaxed">{STORE_ADDRESS_DETAIL}</p>
                <a
                  href={MAPS_URL}
                  target="_blank"
                  rel="noreferrer"
      ...
      <section
        className="mt-8 bg-white rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] border-[1.5px] border-slate-200/60 overflow-hidden animate-slide-up delay-200"
        aria-label="Store location map"
      >
        <div className="px-6 sm:px-8 py-6 border-b border-slate-200/80 bg-slate-50">
          <h2 className="text-xl font-bold text-slate-900 mb-1">Find us on the map</h2>
          <p className="text-sm text-slate-600 leading-relaxed">{STORE_LOCATION_TITLE}</p>
          <p className="text-sm text-slate-500 mt-1">{STORE_ADDRESS_DETAIL}</p>
        </div>
        <div className="relative w-full h-[280px] sm:h-[360px] md:h-[420px] bg-slate-100">
          <iframe
            title="Mishkat Commercial Center — Merkato"
            src={MAP_EMBED_URL}
        ...
        <div className="px-6 sm:px-8 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-white border-t border-slate-200/80">
          <p className="text-xs text-slate-500">Tap below for directions in Google Maps</p>
          <a
            href={MAPS_URL}
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-primary text-white text-sm font-semibold hover:bg-primary-dark transition-colors"
          >
